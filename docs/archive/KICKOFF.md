...
> **歷史封存：2026-09-06。** 本文件是 2026-07-18 從零重寫時的工程起手快照，描述的 repo 狀態、資料格式、CLI 傳輸策略與施工順序已被後續實作與 `.ai/plans/` 決策取代。**不要把本文件當成目前架構或開工依據。** 目前開發導覽請看 [`../ARCHITECTURE.md`](../ARCHITECTURE.md)。

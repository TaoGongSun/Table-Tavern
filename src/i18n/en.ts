...
export const en: Record<MsgKey, string> = {
  ...
  refactorBtnHint: "Ask AI to read the whole card and split it into character/interface/mechanism candidates to review",
  refactorImportBtn: "Import JSON",
  refactorImportBtnHint: "Load an AI refactor result JSON and pick what to keep (free, no quota used — for testing)",
  refactorSurveying: "Surveying the card…",
  refactorExpanding: "Sorting “{name}” {i}/{n}",
  refactorFinishing: "Finishing shared entries…",
  refactorCancel: "Cancel",
  refactorNothingToDo: "Nothing on this card needs sorting",
  refactorPartialFailed: "{n} failed ({names})",
  refactorResultTitle: "All sorted",
  ...
  refactorPlayerRadioLabel: "Player card",
  refactorPlayerNone: "No player",

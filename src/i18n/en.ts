...
export const en: Record<MsgKey, string> = {
  ...
  usageCostNote: "Costs are reference list prices reported by each CLI; subscriptions are not actually charged this way, so use them for relative comparison only.",
  usageDiagOk: "OK",

...
export const en: Record<MsgKey, string> = {
  ...
  usageOutput: "Output",
  usageSavedCost: "Saved",
  usageTotal: "Total",
  usagePing: "Keep-alive ping",
  usageInUse: "In use",
  usageNoUsage: "This source does not report usage",
  usageSavedNote: "The saved amount is estimated from the cost each CLI reports plus its cache discount; subscriptions are not actually charged this way, so use it for relative comparison only.",
  usageDiagOk: "OK",

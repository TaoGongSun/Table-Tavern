...
export const en: Record<MsgKey, string> = {
  ...
  convertEntryPersonaAsk: "This entry looks like a player persona (it contains {{user}}). Convert it to your player card?",
  convertEntryPersonaOk: "Convert to Player Card",
  convertEntryPersonaCancel: "Convert to Character Card",

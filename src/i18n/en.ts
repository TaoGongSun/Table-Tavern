...
export const en: Record<MsgKey, string> = {
  ...
  refactorShellInfoBtn: "AI-Refactored Interface",
  refactorShellInfoBody:
    "This interface was generated by AI refactoring. If it doesn't render correctly, redoing the refactor with a smarter model usually fixes it. You can also close this layer and check the sidebar status panel instead.",

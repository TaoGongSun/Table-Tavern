...
export const en: Record<MsgKey, string> = {
  ...
  // Cache result (the table in usage_log.rs): short label for stats, sentence for the latest round
  usageCacheHit: "Hit",
  usageCacheHitWhy: "Part of the input came from the cache and is billed at the cache rate.",
  usageCacheMissed: "Should have hit",
  ...
  usageModeShared: "Shared prefix",
  usageModeSolo: "Single character",
  usageModeOneshot: "One-off",
  usageModePing: "Keep-alive",

  // Why it missed (only a continued session can work out the expected amount)
  usageCacheReasonExpired: "longer than the app's conservative cache window since the previous message",
  usageCacheReasonBelowExpected: "below the amount that should have been reused",
  usageCacheReasonSkipped: "this CLI response carried no cache marker (known claude CLI bug)",
  ...
  cliSwitchAccountBtn: "Switch Account",

...
export const zh = {
  ...
  refactorProbing: "初判中…",
  refactorUnsupportedCard: "這張卡的介面由外部網站載入，App 接管不了，暫不支援重構這類卡。",
  refactorModeTitle: "這張卡要保留哪種玩法？",
  refactorModeSuggestInterface: "建議保留原卡玩法：{evidence}",
  refactorModeSuggestCharacters: "建議改成多角色對話：{evidence}",
  refactorModeOptInterface: "保留原卡玩法",
  refactorModeOptInterfaceDesc: "玩法跟原卡一樣；人物不會出現在角色清單。",
  refactorModeOptCharacters: "改成多角色對話",
  refactorModeOptCharactersDesc: "卡片介面會消失；改用本 app 的多角色對話。",
  refactorModeGoRecommended: "照建議繼續",
  refactorModeChoose: "自己選",
  refactorModeGo: "繼續",
  ...
  refactorDroppedSection: "已淘汰 {n} 條",
  ...
  openingTranslateTier: "翻譯模型",
  openingRetranslateBtn: "重新翻譯",
  openingTierCliDefault: "CLI 預設",
  ...
  errQuotaApi: "這個 API 可能額度不足，也可能只是暫時被限流。稍後再試；一直這樣就到供應商後台看額度，或換一個 AI 來源。",
  errApiForbidden: "API 拒絕這把金鑰存取這項請求。到供應商後台確認帳號與模型權限，或改用確定有權限的模型。",
  errApiRequest: "API 拒絕了這項請求。照下面的原始訊息檢查 base URL、模型 id 與請求內容。",
  errApiUpstream: "API 供應商那端出錯，判不出原因。先重試一次；還是失敗就換個模型。只在紀錄很長時發生的話可以換幕；經常發生就改用 CLI 訂閱模式。",

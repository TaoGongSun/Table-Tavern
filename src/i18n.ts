...
const zh = {
  ...
  agyInstallStart: "正在自動安裝 Antigravity CLI，請勿關閉此視窗。安裝完成後會自動開啟瀏覽器進行 Google 登入。",
...
const en: Record<MsgKey, string> = {
  ...
  agyInstallStart: "Installing Antigravity CLI automatically. Do not close this window. When installation finishes, your browser will open for Google sign-in.",

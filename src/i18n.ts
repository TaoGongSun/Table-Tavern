...
const zh = {
  ...
  agyInstallBtn: "一鍵安裝",
  agyInstalling: "安裝中，請依終端機視窗指示完成 Google 登入…",
  agyInstallStart: "正在自動安裝 Gemini CLI（Antigravity），請勿關閉此視窗。安裝完成後會自動開啟瀏覽器進行 Google 登入。",
  agyInstallLoginHint: "若瀏覽器開啟了 Google 登入頁，請完成登入；本視窗會自動等待驗證結果…",
  agyInstallSuccess: "驗證成功，已連結，可以關閉終端機視窗。",
  agyInstallFail: "安裝或驗證未完成。你可以關閉此視窗後回到 App 重試，或到 antigravity.google 手動安裝。",
...
const en: Record<MsgKey, string> = {
  ...
  agyInstallBtn: "Install with one click",
  agyInstalling: "Installing — complete Google sign-in in the Terminal window…",
  agyInstallStart: "Installing Gemini CLI (Antigravity) automatically. Do not close this window. When installation finishes, your browser will open for Google sign-in.",
  agyInstallLoginHint: "If your browser opens a Google sign-in page, complete sign-in there; this window will wait for verification automatically…",
  agyInstallSuccess: "Verification succeeded. You are connected and can close this Terminal window.",
  agyInstallFail: "Installation or verification did not finish. Close this window and retry in the app, or install manually at antigravity.google.",

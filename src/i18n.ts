...
const zh = {
  ...
  aiTab: "AI 連線",
  authorTab: "作者",
  authorBlurb: "獨立開發的桌上角色扮演 app。喜歡 Table Tavern 的話，歡迎請作者喝杯咖啡。",
  sponsorBtn: "☕ 請作者喝咖啡",
  closeBtn: "關閉",
  themeLabel: "主題",
  themeDark: "深色",
...
const en: Record<MsgKey, string> = {
  ...
  aiTab: "AI Connection",
  authorTab: "Author",
  authorBlurb: "An indie-built tabletop roleplay app. If you enjoy Table Tavern, consider buying the author a coffee.",

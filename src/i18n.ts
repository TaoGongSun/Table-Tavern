...
const zh = {
  ...
  sceneAdvance: "換場",
  sceneAdvanceHint: "結束本場景：把目前紀錄壓成前情提要，開新場景",
  sceneTooLongHint: "紀錄較長，建議換場壓縮前情",
  pastScenes: "過去的場（{count}）",
  sceneLabel: "第 {n} 場",
  exportScene: "匯出本場",
  sceneExportFileName: "{table} 第 {n} 場 {stamp}",
  ...
  composerAria: "玩家輸入",
  composerPlaceholder: "對「{name}」發言（玩家身分）…",
...
const en: Record<MsgKey, string> = {
  ...
  sceneAdvance: "New scene",
  sceneAdvanceHint: "End this scene: compress the current log into a recap and start a new scene",
  sceneTooLongHint: "This log is getting long — consider starting a new scene to compress it",
  pastScenes: "Past scenes ({count})",
  sceneLabel: "Scene {n}",
  exportScene: "Export this scene",
  sceneExportFileName: "{table} scene {n} {stamp}",
  ...
  composerPlaceholder: "To “{name}” (as the player)…",

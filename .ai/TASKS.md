...
- [st-ecosystem-upgrades](tasks/st-ecosystem-upgrades.md) — SillyTavern 生態五項升級：匯入補強＋巨集替換＋訊息 Markdown＋GM 狀態欄＋條目互轉 — 下一步：目標模式進行中——前三項（匯入補強＋巨集替換＋Markdown 渲染）自驗全綠（cargo test 146＋npm test＋build＋i18n），等實機驗收；續跑第五項互轉，第四項到拍板閘門停

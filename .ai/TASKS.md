...
- [person-promote](tasks/person-promote.md) — AI 認人並合併升格：把散在多條的同一角色併成一張角色卡 — 下一步：2026-08-07 討論立案，七項拍板（AI 認人合併、合併要挑段落不能接字串、多語版挑一版、玩家人設交 AI 判、分得出勢力職階、預設全勾、原條目處置）；待決議已清空，可直接開工；本案先做，[ai-card-refactor](tasks/ai-card-refactor.md) 的 A–E 實測等本案完成後一起跑、兩案一起結案

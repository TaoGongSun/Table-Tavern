...
- [prompt-cache-optimization](tasks/prompt-cache-optimization.md) — 提示詞快取優化：resume 續聊架構（claude lane） — 下一步：包 1 session 檔操作模組完成（2026-08-03 晚，cargo test 188 綠）；接著包 2 resume 流程地基 → 包 3 凍結快照 → 包 4 log → 包 5 GM 合併，整包完成後真桌驗收 hit_rate ≥66%

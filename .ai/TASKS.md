...
## Todo
- [character-card-avatar-issues](tasks/character-card-avatar-issues.md) — 角色卡回饋修訂：頭像間距／角色改名／圖像變更未儲存提示＋移除頭像警告／建卡空名擋下 — 下一步：先拍板「圖像操作暫存 vs 立即生效」與改名的歷史引用連動，其餘四項可直接動工（建議 5→4→1→3→2）

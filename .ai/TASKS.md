...
- [cli-install-windows](tasks/cli-install-windows.md) — CLI 一鍵安裝 Windows 支援（PowerShell 分支） — 下一步：agy 登入改「URL 上屏＋Start-Process 自動開瀏覽器」雙保險已實作（cargo 77 綠），等使用者下令打包後給朋友複測

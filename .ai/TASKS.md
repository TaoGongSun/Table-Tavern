...
- [st-ecosystem-upgrades](tasks/st-ecosystem-upgrades.md) — SillyTavern 生態五項升級：匯入補強＋巨集替換＋訊息 Markdown＋GM 狀態欄＋條目互轉 — 下一步：目標模式進行中——第一項匯入補強＋第二項巨集替換自驗全綠（cargo test 146＋tsc＋i18n），等實機驗收；續跑第三項 Markdown 渲染

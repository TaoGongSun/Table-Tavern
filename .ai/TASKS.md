...
## In progress
- [card-import-flow](tasks/card-import-flow.md) — 匯入流程 v2：單一入口＋收據復原＋第二張卡路由 — 下一步：2026-08-06 追加身分判定改版（三步：人設欄→條目轉換／判準改主按鈕／身分框全開），從第 1 步開工；雙世界書改可融合已驗收。原驗收七項過五項，4／7 仍缺樣本卡

...
- [prompt-cache-optimization](tasks/prompt-cache-optimization.md) — 提示詞快取優化：resume 續聊架構（claude lane） — 下一步：包 1–5 完成（2026-08-04，包 5 GM 旁白＋點名併成一次呼叫）；程式面收工，等真桌驗收 hit_rate ≥66% 後補包 6 額度分頁 UI

...
- [prompt-cache-optimization](tasks/prompt-cache-optimization.md) — 提示詞快取優化：resume 續聊架構（claude lane） — 下一步：包 1–5 完成；2026-08-04 真桌四輪未達標，根因＝claude CLI 2.1.210 resume 隔輪不帶快取標記（官方問題，已加 cache-skipped 診斷）；升級 CLI ≥2.1.217 重測四輪，仍壞則拍板等官方或 API 直連

...
## In progress
- [state-values-mvu](tasks/state-values-mvu.md) — 狀態欄二期：機制格式（IR）＋本地權威數值＋觸發表 — 下一步：包 1（標籤放寬＋`<maintext>` 剝除）2026-08-04 完成、cargo test 222 綠、五張樣本卡自驗過；剩包 2–8，下次挑包 3 或包 2

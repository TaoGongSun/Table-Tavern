...
## 進行中
- [free-player-onboarding](handoffs/free-player-onboarding.md) — 第 1 階段核心程式面已完成；API format 已收進進階 UI，等重跑 `npm run verify` 後做真 OpenRouter OAuth／免費第一句與相容性實機，通過後才開第 2 階段

...
## 進行中
- [free-player-onboarding](handoffs/free-player-onboarding.md) — 第 1 階段施工中：OAuth PKCE／本機 callback／key 落盤／`openrouter/free` bootstrap 後端核心完成，下一段接 onboarding UI 與十語系錯誤文案

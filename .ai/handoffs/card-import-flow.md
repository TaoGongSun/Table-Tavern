...
## Current state
四包全部實作完成、主線逐包複驗綠、逐包 commit。2026-08-05 一輪實機驗收挖出四件並全數修完、逐項通過（身分框文案、腳本提示、開場白按鈕位置、兩路徑對等化），雙世界書封鎖也過。驗收七項通過五項，剩 4、7 卡在沒有合適樣本卡。
...
## Next action
驗收七項只剩 4、7 兩項，且都卡在**沒有合適的樣本卡**（4 要能疊出多筆匯入紀錄的一批卡，7 要一組成對的角色卡＋世界書 JSON）。取得素材後補驗即可結案（狀態改 completed、TASKS.md 行移 DONE.md、本檔 Completed 搬 archive）；在那之前本任務等同做完，不必再排工。

...
## Next action
- 匯入流程 2026-07-28 實機驗收通過，細節見 [handoffs/release-4-theme-pack.md](../handoffs/release-4-theme-pack.md)。
- 使用者走 release-3-kofi 開店上架 `~/Desktop/TableTavern-SponsorPack.ttpack`，回報商品頁網址換 `KOFI_URL`（一行改動）。
